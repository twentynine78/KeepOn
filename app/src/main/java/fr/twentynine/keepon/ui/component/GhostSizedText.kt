 ...
 * line up across screens. The visible text stays vertically centered in the reserved block. Ghosts
 * are [AnnotatedString]s so a styled label (e.g. a bold span) reserves the same size as it renders.
 */
@Composable
fun GhostSizedText(
    text: AnnotatedString,
    ghostTexts: List<AnnotatedString>,
