...
class CommonUtils(private val application: Application) {
    ...
    companion object {
        internal const val ACTION_STOP_FOREGROUND_SCREEN_OFF_SERVICE = "ACTION_STOP_FOREGROUND_SCREEN_OFF_SERVICE"
        internal const val ACTION_SHORTCUT_SET_TIMEOUT = "ACTION_SHORTCUT_SET_TIMEOUT"
        internal const val ACTION_MANAGE_SHORTCUTS = "ACTION_MANAGE_SHORTCUTS"

        internal const val ACTION_MAIN_ACTIVITY_UPDATE_UI = "ACTION_MAIN_ACTIVITY_UPDATE_UI"
        internal const val ACTION_MAIN_ACTIVITY_MISSING_SETTINGS = "ACTION_MAIN_ACTIVITY_MISSING_SETTINGS"
    }
}
