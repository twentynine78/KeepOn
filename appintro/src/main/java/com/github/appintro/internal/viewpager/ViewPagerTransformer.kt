...
internal class ViewPagerTransformer(
    ...
    private var image2PF: Double = 0.0
    ...
    override fun transformPage(page: View, position: Float) {
        when (transformType) {
            ...
            is AppIntroPageTransformerType.Parallax -> {
                ...
                image2PF = transformType.image2ParallaxFactor
    ...
    private fun applyParallax(page: View, position: Float) {
        ...
        page.findViewById<ImageView>(R.id.image2).translationX = computeParallax(page, position, image2PF)
