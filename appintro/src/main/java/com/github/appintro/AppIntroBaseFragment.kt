...
internal const val ARG_DRAWABLE2 = "drawable2"
...
abstract class AppIntroBaseFragment : Fragment(), SlideSelectionListener, SlideBackgroundColorHolder {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (args != null && args.size() != 0) {
            ...
            drawable2 = args.getInt(ARG_DRAWABLE2)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            drawable2 = savedInstanceState.getInt(ARG_DRAWABLE2)
    ...
    override fun onCreateView(
        ...
        val slideImage2 = view.findViewById<ImageView>(R.id.image2)
        ...
        slideImage2.setImageResource(drawable2)
        if (bgDrawable != 0) {
